...
?>
	<form action='validation.php' method='post'>
		...
		<p><label>Address Line 2:<input type="text" name="addressline2" size="20" maxlength="40" placeholder='Address line 2'/></label></p>
		...
		#####
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {$ccountrychoice = $_REQUEST['country'];} 
				else {$countrychoice = '';}
